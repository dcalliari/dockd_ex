...
#
#     PHX_SERVER=true bin/dockd start
#
  ...
  config :dockd, DockdWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/dockd_web/router\.ex$",
        ~r"lib/dockd_web/(controllers|live|components)/.*\.(ex|heex)$"
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :dockd, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
